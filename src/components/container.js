...
export default function Container({ children }) {
  return (
    <div className="container">
      <Helmet defer={false} >
        <title>Mezcal Montreal</title>
        <meta name="description" content= "Fresh Fish Tacos, Guacamole, Ceviche and Shrimp Cocktail. Also your regular homemade Mexican soup, burritos, nachos. Amazing Drinks!"/>
